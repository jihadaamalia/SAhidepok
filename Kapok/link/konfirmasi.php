<html>
  ...
  <body>
    ...
    <div id="one-page" class="ui text container">
      ...
      <table class="ui single line celled striped table">
        <thead>
          <tr>
            <th colspan="2">
              <center><h3>Detail Nama Tempat</h3>
              <h4>(Konfirmasi diterima)</h4></center>
            </th>
          </tr>
        </thead>
        <tbody>
    ...
    <center><div class="ui green button" onclick="window.location='data_kapok.php'"> Terima </div></center>
  </div>
  <br><br>
</body>
