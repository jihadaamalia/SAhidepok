<html ng-app="myapp" ng-controller="usercontroller">
  ...
  <script src="dirPagination.js"></script>
   <script>  
    ...
    function displayData4 (){  
          $http.post("db/db_show4.php").success(function(data){
            $scope.inform4 = data;  
          });  
        }
    ...
    $scope.ProsesInfo = function(info){
          $http.post('db/db_proses.php',{"id":info}).success(function(data){
            ...
            //memanggil display data spy table terupdate
              window.location.href = 'lihat_data_proses.php';
            }
          });
        }
  ...
  <div class="ui four item stackable tabs menu centered">
      <a href="data_kapok.php" class="active item" data-tab="definition">Belum Diproses</a>
      <a href="lihat_data_proses.php" class="item" data-tab="definition">Diproses</a>
 ...
 <div class="ui search" style="float: right; margin-bottom:10px;">
    ...
    <div class="results"></div>
      ...
      <table  ng-init="displayData()" class="ui striped unstackable compact selectable table">
        <thead>
          <tr>
            <th colspan="3">
        ...
        <tbody>
         <tr dir-paginate="ts in inform | filter: searchKeyword |itemsPerPage:5">
            <td class="collapsing">
      ...
      <td class="right aligned collapsing">
          <div class="ui buttons">
            ...
            <button ng-click="ProsesInfo(ts.id_partner)" class="ui icon button">
