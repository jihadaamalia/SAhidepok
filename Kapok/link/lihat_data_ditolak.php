<html ng-app="myapp" ng-controller="usercontroller">
		 ...
		 $scope.viewInfo = function(info){
          $http.post('getid.php',{"id":info}).success(function(data){
            ...
            //pindah halaman stlh dpt session id
              window.location.href = 'data_tempat_ditolak.php';
            }
          });
        }
 ...
 <div class="ui search" style="float: right; margin-bottom:10px;">
    ...
    <div class="results"></div>
      ...
      <table  ng-init="displayData4()" class="ui striped unstackable compact selectable table">
        <thead>
          <tr>
            <th colspan="3">
              <h4> Ditolak </h4>
        ...
        <tbody>
         <tr dir-paginate="ts in inform4 | filter: searchKeyword |itemsPerPage:5">
            <td class="collapsing">
